...
bsasBaseName("AMC0SMOOTHED",         "BLEN:$(AREA):$(POS):0:SMOOTHED"     )
bsasBaseName("AMC0BLEN",             "BLEN:$(AREA):$(POS):0:BLEN"         )
bsasBaseName("AMC0TMITSTAT",         "BLEN:$(AREA):$(POS):0:TMITSTAT"     )
bsasBaseName("AMC0SMOOTHEDFLOAT",    "BLEN:$(AREA):$(POS):0:SMOOTHEDFLOAT")
bsasBaseName("AMC0BLENFLOAT",        "BLEN:$(AREA):$(POS):0:BLENFLOAT"    )
bsasBaseName("AMC0BLSTATUS",         "BLEN:$(AREA):$(POS):0:BLSTATUS"     )
bsasBaseName("AMC0RAW",              "BLEN:$(AREA):$(POS):0:RAW"          )
bsasBaseName("AMC0RAWFLOAT",         "BLEN:$(AREA):$(POS):0:RAWFLOAT"     )
bsasBaseName("AMC1SMOOTHED",         "BLEN:$(AREA):$(POS):1:SMOOTHED"     )
bsasBaseName("AMC1BLEN",             "BLEN:$(AREA):$(POS):1:BLEN"         )
bsasBaseName("AMC1TMITSTAT",         "BLEN:$(AREA):$(POS):1:TMITSTAT"     )
bsasBaseName("AMC1SMOOTHEDFLOAT",    "BLEN:$(AREA):$(POS):1:SMOOTHEDFLOAT")
bsasBaseName("AMC1BLENFLOAT",        "BLEN:$(AREA):$(POS):1:BLENFLOAT"    )
bsasBaseName("AMC1BLSTATUS",         "BLEN:$(AREA):$(POS):1:BLSTATUS"     )
bsasBaseName("AMC1RAW",              "BLEN:$(AREA):$(POS):1:RAW"          )
bsasBaseName("AMC1RAWFLOAT",         "BLEN:$(AREA):$(POS):1:RAWFLOAT"     )
