...
epicsEnvSet("AREA","HRT")
epicsEnvSet("POS","123")

# BLEN attached to AMC0
epicsEnvSet("AMC0_PREFIX","BLEN:$(AREA):$(POS):DET1")

# BLEN attached to AMC1
epicsEnvSet("AMC1_PREFIX","BLEN:$(AREA):$(POS):DET2")
...
addBsa("AMC0:IMAXFLOAT",  "float")
addBsa("AMC0:SUMFLOAT",   "float")
addBsa("AMC0:BLSTATUS",   "uint32")
addBsa("SKIP6",           "unused")
addBsa("SKIP7",           "unused")
addBsa("SKIP8",           "unused")
addBsa("SKIP9",           "unused")
addBsa("SKIP10",          "unused")
addBsa("SKIP11",          "unused")
addBsa("SKIP12",          "unused")
addBsa("SKIP13",          "unused")
addBsa("AMC1:SUM",        "int")
addBsa("AMC1:IMAX",       "int")
addBsa("AMC1:TMIT",       "int")
addBsa("AMC1:IMAXFLOAT",  "float")
addBsa("AMC1:SUMFLOAT",   "float")
...
dbLoadRecords("db/saveLoadConfig.db", "P=${AMC_CARRIER_PREFIX}, PORT=${CPSW_PORT}, SAVE_FILE=/tmp/configDump.yaml, LOAD_FILE=yaml/defaultsPyro03-16-18a.yaml")
